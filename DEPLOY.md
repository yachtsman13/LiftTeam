...
Все QR-коды на этикетках — деталей, ячеек, оборудования и оборудования
в заказе — ведут на **адрес Pi в Tailscale**: `http://100.108.92.92`.
...
определяет размер QR-кода. Самая тесная из четырёх — этикетка оборудования

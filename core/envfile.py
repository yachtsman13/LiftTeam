...
EDITABLE = (
    ...
    ('Счета Точки', (
        ...
        ('TOCHKA_STATEMENT_DAYS', 'Глубина выписки, дней', 'number',
         'За сколько последних дней брать выписку при каждой загрузке.', None),
        ('TOCHKA_STATEMENT_INTERVAL_MINUTES', 'Тянуть выписку раз в, минут',
         'number',
         'Выписка у Точки готовится не сразу, поэтому загрузка может занять '
         'больше одного тика — торопить её чаще не поможет. Ноль — '
         'на каждом тике.', None),
    )),

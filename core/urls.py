...
urlpatterns = [
    ...
    path('parts/<int:pk>/datasheet/', views.part_datasheet_set, name='part_datasheet_set'),
    ...
    path('repair-orders/<int:pk>/diadoc-positions/', views.repair_order_diadoc_positions,
         name='repair_order_diadoc_positions'),

...
- **Отчёты** — план закупок, журнал движений, задолженности; каждый
  выгружается в Excel
- **Печатные акты** — приёма оборудования в ремонт, выполненных работ
  и дефектации, на A4 из карточки заказа; PDF сохраняется через диалог
  печати браузера. Акт дефектации печатается по одной единице: результаты
  диагностики, коды ошибок, гарантийность и оценка стоимости ремонта

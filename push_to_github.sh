#!/bin/bash
# LiftTeam v2.6.0 — Push to GitHub (единый скрипт)
...
echo ""
echo "  ================================================"
echo "   LiftTeam v2.6.0 — Push to GitHub"
echo "  ================================================"
echo ""
...
git add -A
git commit -m "LiftTeam v2.6.0 update" 2>/dev/null || true
...
if git push -u origin main --force; then
    echo ""
    echo "  ================================================"
    echo "   [OK] LiftTeam v2.6.0 успешно отправлен на GitHub"
    echo "  ================================================"
    echo ""
    echo "  URL: $REPO_URL"
    echo ""
